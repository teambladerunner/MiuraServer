...
import model.stocks.StockHistory;
import model.stocks.StockUpdate;
import model.stocks.WatchStock;
import play.Play;
...
public class UserActor extends UntypedActor {
    ...
    public UserActor(WebSocket.Out<JsonNode> out) {
        ...
        for (String stockSymbol : defaultStocks) {
            SystemSupervisor.supervisor().tell(new WatchStock(stockSymbol), getSelf());
        }
    }
